...
export const getUserDataSuccessActionCreator = (payload: IUserInfo): GetUserDataSuccessActionType => {
  return {
...
export const getUserDataFailureActionCreator = ({ error }: { error: string }): GetUserDataFailureActionType => {
  return {
...
type UserActionTypes = GetUserDataRequestActionType | GetUserDataSuccessActionType | GetUserDataFailureActionType

export const userReducer = (state: IUserState = initialState, action: UserActionTypes) => {
  switch (action.type) {
