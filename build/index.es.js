...
var ProjectDetails = function () {
  ...
  return React.createElement(
    ...
    React.createElement(FilesList, null)
  )
}
...
function getUserData(api) {
  ...
  return __generator(this, function (_a) {
    switch (_a.label) {
      ...
      case 1:
        data = _a.sent().data
        return [4 /*yield*/, put(getUserDataSuccess(__assign(__assign({}, data), { id: data.user_id })))]
      case 2:
        _a.sent()
        return [3 /*break*/, 5]
      case 3:
        e_1 = _a.sent()
        return [4 /*yield*/, put(getUserDataFailure(e_1))]
      case 4:
        _a.sent()
        return [3 /*break*/, 5]
      case 5:
...
function configStore() {
  ...
  var middleware = __spreadArrays(getDefaultMiddleware({ thunk: false }), [sagaMiddleware])
...
var DocumentAssetManagement = function () {
  return createElement(
    Provider,
    { store: store },
    createElement(LangProvider, null, createElement(ProjectDetails, null))
  )
}
