...
var TestMUIButton = function (_a) {
    ...
    return (createElement("div", { className: classes.container },
        createElement(Button, { "data-testid": "test-mui-button-component", variant: "contained", color: color }, "Primary")));
};
...
function getUserData(api) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 5]);
                return [4 /*yield*/, call(api, {
                        url: "/user",
                    })];
            case 1:
                data = (_a.sent()).data;
                return [4 /*yield*/, put(getUserDataSuccessActionCreator(__assign(__assign({}, data), { id: data.user_id })))];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3:
                e_1 = _a.sent();
                return [4 /*yield*/, put(getUserDataFailureActionCreator(e_1))];
            case 4:
                _a.sent();
                return [3 /*break*/, 5];
...
function rootSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, all([takeLatest(GET_USER_DATA_REQUEST, getUserData, apiMiddleware)])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var DocumentAssetManagement = function () {
    ...
    return (createElement(Provider, { store: store },
        createElement("section", { className: classes.root, id: "mainAuth" },
            "Hello from DAM",
            createElement(ProjectDetails, null))));
};
