...
var ErrorOutlineIcon = require('@material-ui/icons/ErrorOutline')
...
var IndeterminateCheckBoxIcon = require('@material-ui/icons/IndeterminateCheckBox')
...
var userSlice = toolkit.createSlice({
  ...
  reducers: {
    getUserDataRequest: function (state) {
      state.fetching = true
      state.error = ''
    },
    getUserDataSuccess: function (state, _a) {
      var payload = _a.payload
      state.fetching = false
      state.user = payload
    },
    getUserDataFailure: function (state, _a) {
      var payload = _a.payload
      state.error = payload.error
    },
  },
})
var getUserDataRequest = ((_a = userSlice.actions), _a.getUserDataRequest),
  getUserDataSuccess = _a.getUserDataSuccess,
  getUserDataFailure = _a.getUserDataFailure
var reducer = userSlice.reducer

var selectUser = reselect.createSelector(
  function (state) {
    return state.user
  },
  function (user) {
...
var Empty = function (_a) {
  ...
  return React__default['default'].createElement(
    ...
    React__default['default'].createElement(ErrorOutlineIcon__default['default'], { color: 'secondary' }),
    ...
    React__default['default'].createElement(
      ...
      hasSelected &&
        React__default['default'].createElement(
          ...
          { padding: 'checkbox' },
          React__default['default'].createElement(Checkbox__default['default'], {
            indeterminate: numSelected > 0 && numSelected < rowCount,
            indeterminateIcon: React__default['default'].createElement(IndeterminateCheckBoxIcon__default['default'], {
...
var TableComponent = function (_a) {
  ...
  return React__default['default'].createElement(
    ...
    !!rows &&
      React__default['default'].createElement(
        ...
        React__default['default'].createElement(
          ...
          React__default['default'].createElement(TableHeader, {
                ...
                return React__default['default'].createElement(
                  ...
                  hasSelected &&
                    React__default['default'].createElement(
                      ...
                      React__default['default'].createElement(core.Checkbox, {
    ...
    !!rows && rows.length > 0
      ? React__default['default'].createElement(core.TablePagination, {
      ...
      : React__default['default'].createElement(Empty$1, { text: t('No data found') })
  )
}
      ...
      rowsTemplate: function (row) {
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(MobilePreview, { data: row })
          ),
          React.createElement(
            core.TableCell,
            { align: 'left', 'data-table': 'table-row' },
            React.createElement(
              ...
              React.createElement(core.Box, { mr: 2, display: 'inline-flex' }),
              React.createElement(core.Typography, { noWrap: true, className: classes.cellText })
            )
          ),
          React.createElement(
            core.TableCell,
            { align: 'left', 'data-table': 'table-row' },
            React.createElement(core.Typography, { variant: 'body1', className: classes.cellData })
          ),
          React.createElement(
            core.TableCell,
            { align: 'left', 'data-table': 'table-row' },
            React.createElement(
              ...
              React.createElement(core.Box, { mr: 1 }),
              React.createElement(
                core.Typography,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(core.Box, { mr: 1, display: 'inline-flex', className: classes.cellData }, row.size),
              'KB'
            )
          )
        )
  ...
  return React__default['default'].createElement(
    ...
    React__default['default'].createElement(
      ...
      React__default['default'].createElement(
        ...
        React__default['default'].createElement(TableView, null)
      )
    )
  )
}
...
function apiMiddleware(_a) {
  var _b = _a.url,
    ...
    _f = _a.transform,
    transform = _f === void 0 ? true : _f
  lodash.defaults(headers, {
  ...
  return axios__default['default']({
    ...
    url: url,
    headers: headers,
    params: method === 'GET' && lodash.isObject(data) && !lodash.isEmpty(data) ? data : {},
    ...
    .catch(function (e) {
      var _a
      var msg = ((_a = e.response) === null || _a === void 0 ? void 0 : _a.data.error) || e.message
      if (e.message) {
        var error = new Error(msg)
        error.response = msg || ''
        throw error
...
function getUserData(api) {
  ...
  return __generator(this, function (_a) {
    switch (_a.label) {
      ...
      case 1:
        data = _a.sent().data
        return [4 /*yield*/, effects.put(getUserDataSuccess(__assign(__assign({}, data), { id: data.user_id })))]
      case 2:
        _a.sent()
        return [3 /*break*/, 5]
      case 3:
        e_1 = _a.sent()
        return [4 /*yield*/, effects.put(getUserDataFailure(e_1))]
      case 4:
        _a.sent()
        return [3 /*break*/, 5]
      case 5:
...
// export function* getMemberInfoSaga(api: IApi) {
//   try {
//     const response = yield call(api, {
//       url: appConfig.services.memberInfo,
//       method: 'GET',
//     })
//     yield put(UserActions.getMemberInfoSuccess(response))
//     yield put(UserActions.getSpaceRoleRequest(response.current_space))
//   } catch (e) {
//     yield put(UserActions.getMemberInfoFailure(e.message))
//   }
// }
      ...
      case 0:
        return [
          ...
          effects.all([
             ...
             * User
             */
            effects.takeEvery(getUserDataRequest, getUserData, apiMiddleware),
          ]),
        ]
      case 1:
        _a.sent()
...
function configStore() {
  ...
  var middleware = __spreadArrays(toolkit.getDefaultMiddleware({ thunk: false }), [sagaMiddleware])
