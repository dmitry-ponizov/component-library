...
var TestComponent = function (_a) {
    ...
    return (React__default['default'].createElement("div", { "data-testid": "test-component", className: "test-component test-component-" + theme },
        React__default['default'].createElement("h1", { className: "heading" }, "I'm the test componentddd")));
};
...
var TestMUIButton = function (_a) {
    var color = _a.color;
    var classes = useStyles();
    return (React.createElement("div", { className: classes.container },
        React.createElement(Button__default['default'], { "data-testid": "test-mui-button-component", variant: "contained", color: color }, "Primary")));
};
...
function apiMiddleware(_a) {
    var _b = _a.url, url = _b === void 0 ? "/" : _b, _c = _a.method, method = _c === void 0 ? "GET" : _c, _d = _a.data, data = _d === void 0 ? {} : _d, _e = _a.headers, headers = _e === void 0 ? {} : _e, _f = _a.transform, transform = _f === void 0 ? true : _f;
...
var getUserDataFailureActionCreator = function (_a) {
    var error = _a.error;
    return {
...
function getUserData(api) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 5]);
                return [4 /*yield*/, effects.call(api, {
                        url: "/user",
                    })];
            case 1:
                data = (_a.sent()).data;
                return [4 /*yield*/, effects.put(getUserDataSuccessActionCreator(__assign(__assign({}, data), { id: data.user_id })))];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3:
                e_1 = _a.sent();
                return [4 /*yield*/, effects.put(getUserDataFailureActionCreator(e_1))];
            case 4:
                _a.sent();
                return [3 /*break*/, 5];
...
function rootSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects.all([effects.takeLatest(GET_USER_DATA_REQUEST, getUserData, apiMiddleware)])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.TestMUIButton = TestMUIButton;
